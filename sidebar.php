                ...
                <nav id="sidebarMenu" class="col-md-4 col-lg-3 d-md-block sidebar collapse p-0">
                    ...
                    <div class="position-sticky sidebar-sticky d-flex flex-column justify-content-center align-items-center">
                        <a class="navbar-brand" href="index.php">
                            <img src="images/tjen.png" class="logo-image img-fluid" >
                        </a>
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="book.php">Book</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="story.php">Our Story</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="faq.php">FAQ</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="login.php">Log in</a>
                            </li>
                            <li class="nav-item">
